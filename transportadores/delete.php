...
<br><br><br><label>Para excluir este Transportador clique em CONFIRMAR</label><br><br>
...
<div id="actions" class="row">
	<div class="col-md-12">
	<a href="del.php?idTransportadores=<?php echo $transportador['idTransportadores']; ?>" class="btn btn-primary">CONFIRMAR</a>
