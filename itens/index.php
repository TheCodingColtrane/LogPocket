...
<header>
	<div class="row">
		<div class="col-sm-6">
			<br><br><br><h2>Itens</h2>
		</div>
		<div class="col-sm-6 text-right h2"><br><br><br>
		<a class="btn btn-primary" href="add.php"><i class="fa fa-plus"></i> Adicionar Itens</a>
		</div>
	</div>
</header>
...
<form method="get">
	<tr>
		<td><?php echo $item['idItens']; ?></td>
		<td><?php echo $item['solicitacao_idSolicitacao']; ?></td>
		<td><?php echo $item['quantidade']; ?></td>
		<td><?php echo $item['descricao']; ?></td>
		<td><?php echo $item['dimensoes']; ?></td>
		<td class="actions text-right">
			 <a href="view.php?idItens=<?php echo $item['idItens']; ?>" class="btn btn-sm btn-success"> 
			 <i class="fa fa-eye"></i> Visualizar</a> 
			 <a href="edit.php?idItens=<?php echo $item['idItens']; ?>" class="btn btn-sm btn-warning">
			 <i class="fa fa-pencil"></i> Editar</a>
			 <a href="delete.php?idItens=<?php echo $item['idItens']; ?>" class="btn btn-sm btn-danger">
