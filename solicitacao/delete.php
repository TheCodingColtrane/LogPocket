...
<br><br><br><label>Para excluir esta solicitação clique em CONFIRMAR</label><br><br>
...
<div id="actions" class="row">
	<div class="col-md-12">
	<a href="del.php?idSolicitacao=<?php echo $solicitacao['idSolicitacao']; ?>" class="btn btn-primary">CONFIRMAR</a>
